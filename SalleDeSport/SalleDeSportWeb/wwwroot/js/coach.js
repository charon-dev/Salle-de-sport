...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        ...
        "columns": [
            { "data": "nom", "widht": "20%" },
            { "data": "prenom", "widht": "20%" },
            { "data": "description", "widht": "20%" },
            { "data": "numeroTelephone", "widht": "20%" },
            { "data": "adresseEmail", "widht": "20%" },
            {
                "data": "id",
                "render": function (data) {
                    return `
                    <div class="w-75 btn-group" role="group">
                        <a href="/Admin/Coach/Upsert?id=${data}" class="btn btn-primary mx-2">
                            <i class="bi bi-pencil-square"></i>Modifier
                        </a>
                        <a onClick=Delete('/Admin/Coach/Delete/${data}')
